module core::typing::\test::Indexer
extend \test::Base;

import core::typing::\test::Helper;

public test bool testDisallowRedefinitionOfVariable() {
	str testCaseName = "testDisallowRedefinitionOfVariable";
...
public test bool testDisallowDeclarationWithUnknownEnumType() {
	str testCaseName = "testDisallowDeclarationWithUnknownEnumType";
	if( PRINT ) { println("RUNNING: <testCaseName>"); }
	passed = true;
	str input = "module Test;
				'enum color c;";
